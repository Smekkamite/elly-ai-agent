...
export function parseInvLineTotals(line) {
  // Prefer the slot view whenever the bridge provides slot numbers. Current
  // bridge builds repeat hotbar slots both in HOTBAR and in the full INV
  // section; aggregating both text sections would double-count slots 0..8.
  ...
  // Fallback for older bridge formats that report item counts without slots.
  const out = {};
